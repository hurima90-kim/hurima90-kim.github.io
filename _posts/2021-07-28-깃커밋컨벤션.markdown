...
<h4>🔸 커밋 메시지 사용 예시</h4>
아래 예시는 <a href="https://udacity.github.io/git-styleguide/">유다시티 커밋 메시지 컨벤션</a>에서 제공해주는 예시입니다.<br><br>
